class Weapon_HandGauntletHM extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(1)=SpriteEmitter'KillingWeaponFx.Weapon_HandGauntletHM.SpriteEmitter36'
     ...
     End Object
     Emitters(5)=SpriteEmitter'KillingWeaponFx.Weapon_HandGauntletHM.SpriteEmitter31'

     Begin Object Class=MeshEmitter Name=MeshEmitter8
         StaticMesh=StaticMesh'Killing_Weapon_Effect_ST.HandGauntletHM_B04'
         RenderTwoSided=True
         ...
         LifetimeRange=(Min=1.000000,Max=1.000000)
     End Object
     Emitters(8)=MeshEmitter'KillingWeaponFx.Weapon_HandGauntletHM.MeshEmitter8'

     Begin Object Class=MeshEmitter Name=MeshEmitter33
         StaticMesh=StaticMesh'Killing_Weapon_Effect_ST.HandGauntletHM_OutL'
         RenderTwoSided=True
         UseParticleColor=True
         SpinParticles=True
         UseSizeScale=True
         ...
         SizeScale(1)=(RelativeTime=0.400000,RelativeSize=1.000000)
         SizeScale(2)=(RelativeTime=1.000000,RelativeSize=1.000000)
         StartSizeRange=(X=(Min=1.280000,Max=1.280000),Y=(Min=1.120000,Max=1.120000))
         InitialParticlesPerSecond=1000.000000
         DrawStyle=PTDS_Brighten
         LifetimeRange=(Min=1.000000,Max=1.000000)
     End Object
     Emitters(11)=MeshEmitter'KillingWeaponFx.Weapon_HandGauntletHM.MeshEmitter33'

class Macro_MasterAll extends UnitTest
	config(TestConfig);
...
function LevelUp()
{
	...
	Net.NotiTell(1, "\\\\MyExpUp 10000000000");
...
function MasterSkill3rd()
{
	...
	Net.NotiTell(1, "\\\\GradeInc");

	if (Job == 'OneHand') {
		for(i=0; i<10; i++) {
			Net.NotiTell(1, "\\\\Skill2ndLevelUp UltraEndure");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp AbsoluteDefense");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp BattleCry");
		}

	}
	else if (Job == 'Bare') {
		for(i=0; i<10; i++) {
			Net.NotiTell(1, "\\\\Skill2ndLevelUp GodSpeed");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp DeathHand");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp AuraOfFury");
		}

	}
	else if (Job == 'Red') {
		for(i=0; i<10; i++) {
			Net.NotiTell(1, "\\\\Skill2ndLevelUp ManaSaver");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp SilenceAura");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp WideFury");
		}
	}
	else if (Job == 'Blue') {
		for(i=0; i<10; i++) {
			Net.NotiTell(1, "\\\\Skill2ndLevelUp ManaRebirth");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp WinterRestriction");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp IceStinger");
		}
	}
	else if (Job == 'Bow') {
		for(i=0; i<10; i++) {
			Net.NotiTell(1, "\\\\Skill2ndLevelUp BlindMaker");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp PoisonArrow");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp ScatterShot");
		}
	}
...
function MasterSkill4th()		//AC Skill
{
	local PlayerServerInfo PSI;
	local SepNetInterface Net;
	local name Job;
	...
	if (Job == 'OneHand') {
		for(i=0; i<10; i++) {
			Net.NotiTell(1, "\\\\Skill2ndLevelUp BladeStorm");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp Assault");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp Nightmare");
		}

	}
	else if (Job == 'Bare') {
		for(i=0; i<10; i++) {
			Net.NotiTell(1, "\\\\Skill2ndLevelUp DeathTime");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp Untouchable");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp Riot");
		}

	}
	else if (Job == 'Red') {
		for(i=0; i<10; i++) {
			Net.NotiTell(1, "\\\\Skill2ndLevelUp Explosion");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp Silent");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp AcheronFlame");
		}
	}	

	else if (Job == 'Blue') {
		for(i=0; i<10; i++) {
			Net.NotiTell(1, "\\\\Skill2ndLevelUp Cancelation");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp HailStorm");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp ColdReflection");
		}
	}
	else if (Job == 'Bow') {
		for(i=0; i<10; i++) {
			Net.NotiTell(1, "\\\\Skill2ndLevelUp Eradication");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp Demolition");
			Net.NotiTell(1, "\\\\Skill2ndLevelUp RestraintShot");
		}
	}
}
...
function DropItems()
{
	...
	if (Job == 'OneHand') {
		Net.NotiTell(1, "\\\\DropMagicItem MurcielSword BasicDamage17 LastDamage17 CriticalRate17 MaxDamage17");
		Net.NotiTell(1, "\\\\DropMagicItem BellatrixBlade BasicDamage17 LastDamage17 CriticalRate17 MaxDamage17");
		Net.NotiTell(1, "\\\\DropMagicItem MurcielVambrace BasicDefenseDamage17 AllResist17 StrengthAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem MurcielVambrace BasicDefenseDamage17 AllResist17 StrengthAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem MurcielHelmet BasicDefenseDamage17 AllResist17 VigorAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem MurcielBoots BasicDefenseDamage17 AllResist17 VigorAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem MurcielArmor BasicDefenseDamage17 AllResist17 StrengthAdd17 CriticalRate17");
		Net.NotiTell(1, "\\\\DropMagicItem MurcielShield DodgeRate17 AllResist17 HitRate17 OffsetBlock17");

		//밀리, 레인지용
		Net.NotiTell(1, "\\\\DropMagicItem DelphirothRing SubLastDamage09 MinusDefenseAdd09 AbsResistAdd09 BasicDefenseDamage09");
		Net.NotiTell(1, "\\\\DropMagicItem DelphirothRing SubLastDamage09 MinusDefenseAdd09 AbsResistAdd09 BasicDefenseDamage09");
		Net.NotiTell(1, "\\\\DropMagicItem DelphirothRing SubLastDamage09 MinusDefenseAdd09 AbsResistAdd09 BasicDefenseDamage09");
		Net.NotiTell(1, "\\\\DropMagicItem DelphirothRing SubLastDamage09 MinusDefenseAdd09 AbsResistAdd09 BasicDefenseDamage09");

		Net.NotiTell(1, "\\\\DropMagicItem DelphirothRing SubLastDamage09 MinusDefenseAdd09 AbsResistAdd09 AllResist09");
		Net.NotiTell(1, "\\\\DropMagicItem DelphirothRing SubLastDamage09 MinusDefenseAdd09 AbsResistAdd09 AllResist09");
		Net.NotiTell(1, "\\\\DropMagicItem DelphirothRing SubLastDamage09 MinusDefenseAdd09 AbsResistAdd09 AllResist09");
		Net.NotiTell(1, "\\\\DropMagicItem DelphirothRing SubLastDamage09 MinusDefenseAdd09 AbsResistAdd09 AllResist09");
	}
	else if (Job == 'Bare') {
		Net.NotiTell(1, "\\\\DropMagicItem AcordGauntlet BasicDamage17 LastDamage17 CriticalRate17 MaxDamage17");
		Net.NotiTell(1, "\\\\DropMagicItem BellatrixJamadhar BasicDamage17 LastDamage17 CriticalRate17 MaxDamage17");
		Net.NotiTell(1, "\\\\DropMagicItem AcordVambrace BasicDefenseDamage17 AllResist17 StrengthAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem AcordVambrace BasicDefenseDamage17 AllResist17 StrengthAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem AcordHelmet BasicDefenseDamage17 AllResist17 VigorAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem AcordBoots BasicDefenseDamage17 AllResist17 VigorAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem AcordArmor BasicDefenseDamage17 AllResist17 StrengthAdd17 CriticalRate17");
		Net.NotiTell(1, "\\\\DropMagicItem AcordProtector DodgeRate17 AllResist17 HitRate17 OffsetBlock17");
		...
		Net.NotiTell(1, "\\\\DropMagicItem AblazeVambrace BasicDefenseDamage17 AllResist17 StrengthAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem AblazeVambrace BasicDefenseDamage17 AllResist17 StrengthAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem AblazeHelmet BasicDefenseDamage17 AllResist17 VigorAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem AblazeBoots BasicDefenseDamage17 AllResist17 VigorAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem AblazeGarment BasicDefenseDamage17 AllResist17 StrengthAdd17 ManaRegenAdd17");

		//법사용
		Net.NotiTell(1, "\\\\DropMagicItem DelphirothRing SubLastSkillDamage11 MinusDefenseAdd09 AbsResistAdd09 BasicDefenseDamage09");
		Net.NotiTell(1, "\\\\DropMagicItem DelphirothRing SubLastSkillDamage11 MinusDefenseAdd09 AbsResistAdd09 BasicDefenseDamage09");
		Net.NotiTell(1, "\\\\DropMagicItem DelphirothRing SubLastSkillDamage11 MinusDefenseAdd09 AbsResistAdd09 BasicDefenseDamage09");
		Net.NotiTell(1, "\\\\DropMagicItem DelphirothRing SubLastSkillDamage11 MinusDefenseAdd09 AbsResistAdd09 BasicDefenseDamage09");

		Net.NotiTell(1, "\\\\DropMagicItem DelphirothRing SubLastSkillDamage11 MinusDefenseAdd09 AbsResistAdd09 AllResist09");
		Net.NotiTell(1, "\\\\DropMagicItem DelphirothRing SubLastSkillDamage11 MinusDefenseAdd09 AbsResistAdd09 AllResist09");
		Net.NotiTell(1, "\\\\DropMagicItem DelphirothRing SubLastSkillDamage11 MinusDefenseAdd09 AbsResistAdd09 AllResist09");
		Net.NotiTell(1, "\\\\DropMagicItem DelphirothRing SubLastSkillDamage11 MinusDefenseAdd09 AbsResistAdd09 AllResist09");

		Net.NotiTell(1, "\\\\DropMagicItem DelphirothBandNew LastSkillDamage09 SubLastSkillDamage14 BasicDamage09 AllResist09");
		Net.NotiTell(1, "\\\\DropMagicItem DelphirothBandNew LastSkillDamage09 SubLastSkillDamage14 BasicDamage09 AllResist09");

		Net.NotiTell(1, "\\\\DropMagicItem DelphirothAmulet SkillDamage09 LastSkillDamage09 SubSkillDamage14 SubLastSkillDamage14");
		...
		Net.NotiTell(1, "\\\\DropMagicItem GlaciesGown BasicDefenseDamage17 AllResist17 StrengthAdd17 ManaRegenAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem GlaciesSleevelet BasicDefenseDamage17 AllResist17 StrengthAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem GlaciesSleevelet BasicDefenseDamage17 AllResist17 StrengthAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem GlaciesSandal BasicDefenseDamage17 AllResist17 VigorAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem GlaciesCap BasicDefenseDamage17 AllResist17 VigorAdd17 DexterityAdd17");
		...
		Net.NotiTell(1, "\\\\DropMagicItem ApliteBow BasicDamage17 LastDamage17 CriticalRate17 OffsetBlock17");
		...
		Net.NotiTell(1, "\\\\DropMagicItem ApliteSandal BasicDefenseDamage17 AllResist17 VigorAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem ApliteSleevelet BasicDefenseDamage17 AllResist17 StrengthAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem ApliteSleevelet BasicDefenseDamage17 AllResist17 StrengthAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem ApliteCap BasicDefenseDamage17 AllResist17 VigorAdd17 DexterityAdd17");
		Net.NotiTell(1, "\\\\DropMagicItem ApliteGarb BasicDefenseDamage17 AllResist17 StrengthAdd17 CriticalRate17");
	...
	Net.NotiTell(1, "\\\\DropMagicItem DelphirothBandNew PSD09 SPSD13 MDEF07");	//물리스킬공격력, 보조물리스킬공격력, 마법방어력
	Net.NotiTell(1, "\\\\DropMagicItem DelphirothBandNew PSD09 SPSD13 MDEF07");
	Net.NotiTell(1, "\\\\DropMagicItem DelphirothAmulet PD09 PSD09 SPD13 SPSD13");
	Net.NotiTell(1, "\\\\DropMagicItem DelphirothAmulet MD09 MSD09 SMD13 SMSD13");
	Net.NotiTell(1, "\\\\DropMagicItem DelphirothBandNew MSD09 SMSD13 MDEF07");
	Net.NotiTell(1, "\\\\DropMagicItem DelphirothBandNew MSD09 SMSD13 MDEF07");

	
	
	Net.NotiTell(1, "\\\\DropItem Market_FastScroll_2H");	
	Net.NotiTell(1, "\\\\DropItem Market_AttackPotion_2H");
	Net.NotiTell(1, "\\\\DropItem Market_SpeedScroll_2H");
	...
	Net.NotiTell(1, "\\\\DropItem Market_InventoryBag1_1D"); 

	Net.NotiTell(1, "\\\\SetQuest DQ_SoulCave_Open 0");
	Net.NotiTell(1, "\\\\SetQuest DQD_PrepareForAction 0");
...
defaultproperties
{
     ...
     Weight(0)=(str=0.440000,Dex=0.228000,Vigor=0.300000,Mp=0.032000)
     Weight(1)=(str=0.080000,Dex=0.160000,Vigor=0.300000,Mp=0.460000)
     Weight(2)=(str=0.260000,Dex=0.400000,Vigor=0.240000,Mp=0.090000)
     Weight(3)=(str=0.410000,Dex=0.269000,Vigor=0.290000,Mp=0.031000)
     TestTimer=1.000000
}
